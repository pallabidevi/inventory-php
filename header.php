...
<?php 
    ...
    $select_user = "select * from users where userid = '$sesid'";
    $u = mysqli_query($conn, $select_user);
    $user = mysqli_fetch_array($u);
    $divid = $user['divid'];
    
    $rsu=mysqli_query($conn,"select count(*) as a from activity");
    $ac=mysqli_fetch_array($rsu);

    $rse=mysqli_query($conn,"select count(*) as n from notification where whom_to_notify='$divid'");
    $no=mysqli_fetch_array($rse);

    $select_activity = "select * from activity a join users u on a.userid=u.userid order by id desc limit 3";
    $all_activity = mysqli_query($conn, $select_activity);

   
    $rs=mysqli_query($conn, "select * from users where userid='$sesid' ");

    $select_notify = "select * from notification as n, users as u where n.usend= u.divid and n.whom_to_notify='$divid' order by id desc limit 3";
        ...
        <aside class="menu-sidebar d-none d-lg-block">
            ...
            <div class="menu-sidebar__content js-scrollbar1">
                <nav class="navbar-sidebar">
                    ...
                    <li class="has-sub">
                            <a class="js-arrow" href="recent_activity.php">
                             <i class="fas fa-envelope-open"></i>Recent Activity</a>
                    </li>
                    <li class="has-sub">
                            <a class="js-arrow" href="help.php">
                        ...
                        <div class="header-wrap">
                            ...
                            <div class="header-button">
                                    ...
                                    <div class="noti__item js-item-menu">
                                        ...
                                        <span class="quantity"><?php echo $no['n']; ?></span>
                                        ...
                                        <div class="notifi-dropdown js-dropdown">
                                            ...
                                            <?php
                                                    while($row2 = mysqli_fetch_array($all_notify)){
                                                        
                                                        ?>
                                                        
                                                    <div onclick="location.href='delete_notification.php?id=<?php echo $row2['id'];?>'"  class="notifi__item">
                                                        <div class="bg-c2 img-cir img-40">
                                                             <i class="zmdi zmdi-account-box"></i>
                                                                <div class="image img-cir img-40">
                                                                    <img src="<?php echo $row2['userpic']; ?>" />
                                                                </div>
                                                        </div>
                                                        <div class="content">
